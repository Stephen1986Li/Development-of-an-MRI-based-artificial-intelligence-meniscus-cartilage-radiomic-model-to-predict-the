...
JMP_SCORE_API void fillOutputMetadata(FIELDMD *fd) {
    strcpy_safe(fd[0].name, "概率 ( itype1=Case )");
    fd[0].type = fnum_type;
    fd[0].datalen = 0;        

    strcpy_safe(fd[1].name, "概率 ( itype1=Control )");
    fd[1].type = fnum_type;
    fd[1].datalen = 0;        

    strcpy_safe(fd[2].name, "最可能的“itype1”_1");
    fd[2].type = char_type;
    fd[2].datalen = 8;        
}
...
// Original name was: '概率 ( itype1=Case )'
#define _OUTDATA_0                 outdata[0].data.fnum
// Original name was: '概率 ( itype1=Control )'
#define _OUTDATA_1                 outdata[1].data.fnum
// Original name was: '最可能的“itype1”_1'
#define _OUTDATA_2                 outdata[2].data.str  // max string length: 7
...
JMP_SCORE_API void score(PARM *indata, PARM *outdata) {
    ...
    _OUTDATA_0 = jmp_squish((-172.314275759506 + 0.0698069198722904 * ORIGINAL_FIRSTORDER_MINIMUM_FC + -34.5287138545909 * ORIGINAL_GLSZM_SMALLAREAEMPHASIS_FC + 7.52847283555431 * ORIGINAL_SHAPE_ELONGATION_LM + 24.8320833122873 * ORIGINAL_SHAPE_SPHERICITY_MM + 217.495246919398 * V455_FC + 38.9676918327534 * V620_FC + -14.8691202157608 * V810_MM + 0.0602888949136799 * WAVELETHHH_FIRSTORDER_MINIMUM_FC + 89.2495344791801 * WAVELETHHH_GLCM_CLUSTERSHADE_MM + 213.773098091994 * WAVELETHHH_GLCM_IMC1_LM + -17.6276240728582 * WAVELETHHH_GLRLM_RUNVARIANCE_MM + 0.0000000080719363555 * WAVELETHHH_GLSZM_LARGEAREAHIGHGR_FC + -8.38605622822001 * WAVELETHHL_FIRSTORDER_MEAN_MM + 3.2364724806286 * WAVELETHHL_GLCM_CLUSTERPROMINENC_FC + 81.8360980927234 * WAVELETHHL_GLCM_CORRELATION_MM + -167.384837720787 * WAVELETHHL_GLCM_IMC1_MM + -81.0820217266207 * WAVELETHHL_GLCM_IMC1_TC + 621.763588160631 * WAVELETHHL_GLDM_SMALLDEPENDENCEL_FC + 632.411254057462 * WAVELETHHL_GLDM_SMALLDEPENDENCEL_MM + 0.0710881207259484 * WAVELETHHL_GLRLM_LONGRUNHIGHGRAY_MM + -8.351738303974 * WAVELETHHL_GLSZM_GRAYLEVELVARIAN_MM + -0.0000040561045732148 * WAVELETHHL_GLSZM_LARGEAREALOWGRA_FC + 26.9670478158734 * WAVELETHHL_GLSZM_SMALLAREAEMPHAS_FC + 2.67589095757834 * WAVELETHLH_FIRSTORDER_MEDIAN_LM + -0.0000000600164173229 * WAVELETHLH_GLSZM_LARGEAREAHIGHGR_TC + 1.86950561596052 * WAVELETHLH_GLSZM_ZONEENTROPY_TC + 0.429287840979061 * WAVELETHLL_FIRSTORDER_KURTOSIS_MM + -3.3301283354265 * WAVELETHLL_FIRSTORDER_SKEWNESS_LM + 0.00320049649204003 * WAVELETHLL_GLSZM_GRAYLEVELNONUNI_FC + 0.0000096137070879199 * WAVELETHLL_GLSZM_LARGEAREALOWGRA_LM + 36.5045204583078 * WAVELETHLL_GLSZM_SMALLAREAEMPHAS_FC + 0.0114133947661589 * WAVELETHLL_NGTDM_BUSYNESS_MM + -0.014209835899086 * WAVELETLHH_FIRSTORDER_MAXIMUM_MM + 1.85250947419981 * WAVELETLHH_FIRSTORDER_MEDIAN_LM + 5.59512662546722 * WAVELETLHH_GLSZM_SMALLAREAEMPHAS_MM + 0.00854410262392001 * WAVELETLHL_FIRSTORDER_MINIMUM_TC + -4.60982515805346 * WAVELETLHL_FIRSTORDER_SKEWNESS_FC + 2.77392733677797 * WAVELETLHL_FIRSTORDER_SKEWNESS_TC + 0.434544097213904 * WAVELETLHL_GLCM_CLUSTERSHADE_FC + 2.37371532631983 * WAVELETLHL_GLSZM_ZONEENTROPY_LM + 2.19071943478082 * WAVELETLHL_GLSZM_ZONEENTROPY_MM + 0.00545600840256806 * WAVELETLLH_FIRSTORDER_MINIMUM_FC + 23.6600207591023 * WAVELETLLH_GLCM_CORRELATION_MM + 59.9111630785163 * WAVELETLLH_GLCM_IMC1_MM + -675.256556331641 * WAVELETLLH_GLDM_SMALLDEPENDENCEL_MM + 4.98801409541456 * WAVELETLLH_GLSZM_ZONEENTROPY_FC + -0.0029447507382415 * WAVELETLLL_GLCM_CLUSTERSHADE_LM + 91.6163084067093 * WAVELETLLL_GLCM_IDN_FC + -0.0000923483577302275 * WAVELETLLL_GLDM_LARGEDEPENDENCEH_LM + -0.00251156764446676 * WAVELETLLL_GLSZM_GRAYLEVELNONUNI_FC + -0.127240045441525 * WAVELETLLL_GLSZM_GRAYLEVELVARIAN_MM + 0.24205064244792 * WAVELETLLL_NGTDM_BUSYNESS_TC));

    _OUTDATA_1 = 1 + -1 * jmp_squish((-172.314275759506 + 0.0698069198722904 * ORIGINAL_FIRSTORDER_MINIMUM_FC + -34.5287138545909 * ORIGINAL_GLSZM_SMALLAREAEMPHASIS_FC + 7.52847283555431 * ORIGINAL_SHAPE_ELONGATION_LM + 24.8320833122873 * ORIGINAL_SHAPE_SPHERICITY_MM + 217.495246919398 * V455_FC + 38.9676918327534 * V620_FC + -14.8691202157608 * V810_MM + 0.0602888949136799 * WAVELETHHH_FIRSTORDER_MINIMUM_FC + 89.2495344791801 * WAVELETHHH_GLCM_CLUSTERSHADE_MM + 213.773098091994 * WAVELETHHH_GLCM_IMC1_LM + -17.6276240728582 * WAVELETHHH_GLRLM_RUNVARIANCE_MM + 0.0000000080719363555 * WAVELETHHH_GLSZM_LARGEAREAHIGHGR_FC + -8.38605622822001 * WAVELETHHL_FIRSTORDER_MEAN_MM + 3.2364724806286 * WAVELETHHL_GLCM_CLUSTERPROMINENC_FC + 81.8360980927234 * WAVELETHHL_GLCM_CORRELATION_MM + -167.384837720787 * WAVELETHHL_GLCM_IMC1_MM + -81.0820217266207 * WAVELETHHL_GLCM_IMC1_TC + 621.763588160631 * WAVELETHHL_GLDM_SMALLDEPENDENCEL_FC + 632.411254057462 * WAVELETHHL_GLDM_SMALLDEPENDENCEL_MM + 0.0710881207259484 * WAVELETHHL_GLRLM_LONGRUNHIGHGRAY_MM + -8.351738303974 * WAVELETHHL_GLSZM_GRAYLEVELVARIAN_MM + -0.0000040561045732148 * WAVELETHHL_GLSZM_LARGEAREALOWGRA_FC + 26.9670478158734 * WAVELETHHL_GLSZM_SMALLAREAEMPHAS_FC + 2.67589095757834 * WAVELETHLH_FIRSTORDER_MEDIAN_LM + -0.0000000600164173229 * WAVELETHLH_GLSZM_LARGEAREAHIGHGR_TC + 1.86950561596052 * WAVELETHLH_GLSZM_ZONEENTROPY_TC + 0.429287840979061 * WAVELETHLL_FIRSTORDER_KURTOSIS_MM + -3.3301283354265 * WAVELETHLL_FIRSTORDER_SKEWNESS_LM + 0.00320049649204003 * WAVELETHLL_GLSZM_GRAYLEVELNONUNI_FC + 0.0000096137070879199 * WAVELETHLL_GLSZM_LARGEAREALOWGRA_LM + 36.5045204583078 * WAVELETHLL_GLSZM_SMALLAREAEMPHAS_FC + 0.0114133947661589 * WAVELETHLL_NGTDM_BUSYNESS_MM + -0.014209835899086 * WAVELETLHH_FIRSTORDER_MAXIMUM_MM + 1.85250947419981 * WAVELETLHH_FIRSTORDER_MEDIAN_LM + 5.59512662546722 * WAVELETLHH_GLSZM_SMALLAREAEMPHAS_MM + 0.00854410262392001 * WAVELETLHL_FIRSTORDER_MINIMUM_TC + -4.60982515805346 * WAVELETLHL_FIRSTORDER_SKEWNESS_FC + 2.77392733677797 * WAVELETLHL_FIRSTORDER_SKEWNESS_TC + 0.434544097213904 * WAVELETLHL_GLCM_CLUSTERSHADE_FC + 2.37371532631983 * WAVELETLHL_GLSZM_ZONEENTROPY_LM + 2.19071943478082 * WAVELETLHL_GLSZM_ZONEENTROPY_MM + 0.00545600840256806 * WAVELETLLH_FIRSTORDER_MINIMUM_FC + 23.6600207591023 * WAVELETLLH_GLCM_CORRELATION_MM + 59.9111630785163 * WAVELETLLH_GLCM_IMC1_MM + -675.256556331641 * WAVELETLLH_GLDM_SMALLDEPENDENCEL_MM + 4.98801409541456 * WAVELETLLH_GLSZM_ZONEENTROPY_FC + -0.0029447507382415 * WAVELETLLL_GLCM_CLUSTERSHADE_LM + 91.6163084067093 * WAVELETLLL_GLCM_IDN_FC + -0.0000923483577302275 * WAVELETLLL_GLDM_LARGEDEPENDENCEH_LM + -0.00251156764446676 * WAVELETLLL_GLSZM_GRAYLEVELNONUNI_FC + -0.127240045441525 * WAVELETLLL_GLSZM_GRAYLEVELVARIAN_MM + 0.24205064244792 * WAVELETLLL_NGTDM_BUSYNESS_TC));

    _temp_1[0] = _OUTDATA_0;
    _temp_1[1] = _OUTDATA_1;
    ...
    strcpy_safe(_OUTDATA_2, _temp_2);
