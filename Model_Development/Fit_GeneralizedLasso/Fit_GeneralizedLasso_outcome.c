...
JMP_SCORE_API void fillInputMetadata(FIELDMD *fd) {
    ...
    strcpy_safe(fd[52].name, "Probability( itype1=Control )");
    fd[52].type = fnum_type;
    fd[52].datalen = 0;        

    strcpy_safe(fd[53].name, "Probability( itype1=Case )");
    fd[53].type = fnum_type;
    fd[53].datalen = 0;        
}

JMP_SCORE_API void fillOutputMetadata(FIELDMD *fd) {
    strcpy_safe(fd[0].name, "Probability( itype1=Control ),!Probability( itype1=Control )");
    fd[0].type = fnum_type;
    fd[0].datalen = 0;        

    strcpy_safe(fd[1].name, "Probability( itype1=Case ),!Probability( itype1=Case )");
    fd[1].type = fnum_type;
    fd[1].datalen = 0;        
...
#define PROBABILITY_ITYPE1_CONTROL_         indata[52].data.fnum
// Original name was: 'Probability( itype1=Case )'
#define PROBABILITY_ITYPE1_CASE_            indata[53].data.fnum

// Original name was: 'Probability( itype1=Control ),!Probability( itype1=Control )'
#define PROBABILITY_ITYPE1_CONTROL_PROBABILITY_ITYPE1_CONTROL_       outdata[0].data.fnum
// Original name was: 'Probability( itype1=Case ),!Probability( itype1=Case )'
#define PROBABILITY_ITYPE1_CASE_PROBABILITY_ITYPE1_CASE_             outdata[1].data.fnum
...
JMP_SCORE_API void score(PARM *indata, PARM *outdata) {
    ...
    PROBABILITY_ITYPE1_CONTROL_PROBABILITY_ITYPE1_CONTROL_ = jmp_squish((138.906662284563 + -0.0374840613777587 * ORIGINAL_FIRSTORDER_MINIMUM_FC + 30.0851204984573 * ORIGINAL_GLSZM_SMALLAREAEMPHASIS_FC + -5.16886931938608 * ORIGINAL_SHAPE_ELONGATION_LM + -22.6027937197107 * ORIGINAL_SHAPE_SPHERICITY_MM + -183.241411245849 * V455_FC + -31.2864884900061 * V620_FC + 13.0929184029347 * V810_MM + -0.0449150326270933 * WAVELETHHH_FIRSTORDER_MINIMUM_FC + -80.5541121951956 * WAVELETHHH_GLCM_CLUSTERSHADE_MM + -175.513292031235 * WAVELETHHH_GLCM_IMC1_LM + 14.1388520672465 * WAVELETHHH_GLRLM_RUNVARIANCE_MM + -0.0000000065806757192 * WAVELETHHH_GLSZM_LARGEAREAHIGHGR_FC + 8.44401662768123 * WAVELETHHL_FIRSTORDER_MEAN_MM + -2.50698631344467 * WAVELETHHL_GLCM_CLUSTERPROMINENC_FC + -70.4834404869617 * WAVELETHHL_GLCM_CORRELATION_MM + 135.159288730406 * WAVELETHHL_GLCM_IMC1_MM + 68.3596341150643 * WAVELETHHL_GLCM_IMC1_TC + -580.872797304735 * WAVELETHHL_GLDM_SMALLDEPENDENCEL_FC + -634.382491552537 * WAVELETHHL_GLDM_SMALLDEPENDENCEL_MM + -0.0725533381359363 * WAVELETHHL_GLRLM_LONGRUNHIGHGRAY_MM + 7.05678012366991 * WAVELETHHL_GLSZM_GRAYLEVELVARIAN_MM + 0.0000034063862657645 * WAVELETHHL_GLSZM_LARGEAREALOWGRA_FC + -23.7451543847941 * WAVELETHHL_GLSZM_SMALLAREAEMPHAS_FC + -2.46711982513115 * WAVELETHLH_FIRSTORDER_MEDIAN_LM + 0.000000052516315218 * WAVELETHLH_GLSZM_LARGEAREAHIGHGR_TC + -1.61594579730143 * WAVELETHLH_GLSZM_ZONEENTROPY_TC + -0.315597348534774 * WAVELETHLL_FIRSTORDER_KURTOSIS_MM + 2.72362187343286 * WAVELETHLL_FIRSTORDER_SKEWNESS_LM + -0.00363176200000953 * WAVELETHLL_GLSZM_GRAYLEVELNONUNI_FC + -0.0000108750618386455 * WAVELETHLL_GLSZM_LARGEAREALOWGRA_LM + -34.6049578360473 * WAVELETHLL_GLSZM_SMALLAREAEMPHAS_FC + -0.00622267395786139 * WAVELETHLL_NGTDM_BUSYNESS_MM + 0.0125102964039785 * WAVELETLHH_FIRSTORDER_MAXIMUM_MM + -1.63901757644153 * WAVELETLHH_FIRSTORDER_MEDIAN_LM + -5.4573283165394 * WAVELETLHH_GLSZM_SMALLAREAEMPHAS_MM + -0.00913208687306463 * WAVELETLHL_FIRSTORDER_MINIMUM_TC + 3.82470924731225 * WAVELETLHL_FIRSTORDER_SKEWNESS_FC + -2.44052577290932 * WAVELETLHL_FIRSTORDER_SKEWNESS_TC + -0.271269630988434 * WAVELETLHL_GLCM_CLUSTERSHADE_FC + -2.22075325292815 * WAVELETLHL_GLSZM_ZONEENTROPY_LM + -1.73129068376673 * WAVELETLHL_GLSZM_ZONEENTROPY_MM + -0.0049465095877357 * WAVELETLLH_FIRSTORDER_MINIMUM_FC + -22.7839150149442 * WAVELETLLH_GLCM_CORRELATION_MM + -49.4931066442567 * WAVELETLLH_GLCM_IMC1_MM + 508.07815254672 * WAVELETLLH_GLDM_SMALLDEPENDENCEL_MM + -4.27054091625983 * WAVELETLLH_GLSZM_ZONEENTROPY_FC + 0.00258323341544075 * WAVELETLLL_GLCM_CLUSTERSHADE_LM + -66.2396707106205 * WAVELETLLL_GLCM_IDN_FC + 0.0000154180694582632 * WAVELETLLL_GLDM_LARGEDEPENDENCEH_LM + 0.00278500701223195 * WAVELETLLL_GLSZM_GRAYLEVELNONUNI_FC + 0.12855055853742 * WAVELETLLL_GLSZM_GRAYLEVELVARIAN_MM + -0.237040444584005 * WAVELETLLL_NGTDM_BUSYNESS_TC));

    PROBABILITY_ITYPE1_CASE_PROBABILITY_ITYPE1_CASE_ = 1 + -1 * jmp_squish((138.906662284563 + -0.0374840613777587 * ORIGINAL_FIRSTORDER_MINIMUM_FC + 30.0851204984573 * ORIGINAL_GLSZM_SMALLAREAEMPHASIS_FC + -5.16886931938608 * ORIGINAL_SHAPE_ELONGATION_LM + -22.6027937197107 * ORIGINAL_SHAPE_SPHERICITY_MM + -183.241411245849 * V455_FC + -31.2864884900061 * V620_FC + 13.0929184029347 * V810_MM + -0.0449150326270933 * WAVELETHHH_FIRSTORDER_MINIMUM_FC + -80.5541121951956 * WAVELETHHH_GLCM_CLUSTERSHADE_MM + -175.513292031235 * WAVELETHHH_GLCM_IMC1_LM + 14.1388520672465 * WAVELETHHH_GLRLM_RUNVARIANCE_MM + -0.0000000065806757192 * WAVELETHHH_GLSZM_LARGEAREAHIGHGR_FC + 8.44401662768123 * WAVELETHHL_FIRSTORDER_MEAN_MM + -2.50698631344467 * WAVELETHHL_GLCM_CLUSTERPROMINENC_FC + -70.4834404869617 * WAVELETHHL_GLCM_CORRELATION_MM + 135.159288730406 * WAVELETHHL_GLCM_IMC1_MM + 68.3596341150643 * WAVELETHHL_GLCM_IMC1_TC + -580.872797304735 * WAVELETHHL_GLDM_SMALLDEPENDENCEL_FC + -634.382491552537 * WAVELETHHL_GLDM_SMALLDEPENDENCEL_MM + -0.0725533381359363 * WAVELETHHL_GLRLM_LONGRUNHIGHGRAY_MM + 7.05678012366991 * WAVELETHHL_GLSZM_GRAYLEVELVARIAN_MM + 0.0000034063862657645 * WAVELETHHL_GLSZM_LARGEAREALOWGRA_FC + -23.7451543847941 * WAVELETHHL_GLSZM_SMALLAREAEMPHAS_FC + -2.46711982513115 * WAVELETHLH_FIRSTORDER_MEDIAN_LM + 0.000000052516315218 * WAVELETHLH_GLSZM_LARGEAREAHIGHGR_TC + -1.61594579730143 * WAVELETHLH_GLSZM_ZONEENTROPY_TC + -0.315597348534774 * WAVELETHLL_FIRSTORDER_KURTOSIS_MM + 2.72362187343286 * WAVELETHLL_FIRSTORDER_SKEWNESS_LM + -0.00363176200000953 * WAVELETHLL_GLSZM_GRAYLEVELNONUNI_FC + -0.0000108750618386455 * WAVELETHLL_GLSZM_LARGEAREALOWGRA_LM + -34.6049578360473 * WAVELETHLL_GLSZM_SMALLAREAEMPHAS_FC + -0.00622267395786139 * WAVELETHLL_NGTDM_BUSYNESS_MM + 0.0125102964039785 * WAVELETLHH_FIRSTORDER_MAXIMUM_MM + -1.63901757644153 * WAVELETLHH_FIRSTORDER_MEDIAN_LM + -5.4573283165394 * WAVELETLHH_GLSZM_SMALLAREAEMPHAS_MM + -0.00913208687306463 * WAVELETLHL_FIRSTORDER_MINIMUM_TC + 3.82470924731225 * WAVELETLHL_FIRSTORDER_SKEWNESS_FC + -2.44052577290932 * WAVELETLHL_FIRSTORDER_SKEWNESS_TC + -0.271269630988434 * WAVELETLHL_GLCM_CLUSTERSHADE_FC + -2.22075325292815 * WAVELETLHL_GLSZM_ZONEENTROPY_LM + -1.73129068376673 * WAVELETLHL_GLSZM_ZONEENTROPY_MM + -0.0049465095877357 * WAVELETLLH_FIRSTORDER_MINIMUM_FC + -22.7839150149442 * WAVELETLLH_GLCM_CORRELATION_MM + -49.4931066442567 * WAVELETLLH_GLCM_IMC1_MM + 508.07815254672 * WAVELETLLH_GLDM_SMALLDEPENDENCEL_MM + -4.27054091625983 * WAVELETLLH_GLSZM_ZONEENTROPY_FC + 0.00258323341544075 * WAVELETLLL_GLCM_CLUSTERSHADE_LM + -66.2396707106205 * WAVELETLLL_GLCM_IDN_FC + 0.0000154180694582632 * WAVELETLLL_GLDM_LARGEDEPENDENCEH_LM + 0.00278500701223195 * WAVELETLLL_GLSZM_GRAYLEVELNONUNI_FC + 0.12855055853742 * WAVELETLLL_GLSZM_GRAYLEVELVARIAN_MM + -0.237040444584005 * WAVELETLLL_NGTDM_BUSYNESS_TC));

    _temp_1[0] = PROBABILITY_ITYPE1_CONTROL_;
    _temp_1[1] = PROBABILITY_ITYPE1_CASE_;
